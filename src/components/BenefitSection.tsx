...
export default function BenefitSection({ onSelectBenefit }: BenefitSectionProps) {
  return (
    <div className="p-4 space-y-4">
      {/* 상단 소개 배너 */}
      <div className="p-4 rounded-3xl bg-gradient-to-br from-amber-50 via-orange-50/50 to-white border border-amber-200 shadow-sm">
      ...
      <div className="space-y-3">
        {PARTNER_BENEFITS.map((benefit) => (
          <div
            ...
            className="p-3.5 rounded-2xl bg-white border border-slate-200 hover:border-amber-400/80 transition-all cursor-pointer group shadow-sm"
          >
            <div className="flex space-x-3">
              ...
              <div className="relative w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 bg-slate-100 border border-slate-200">
                ...
                />
                <div className="absolute top-1 left-1 px-1.5 py-0.5 rounded bg-amber-500 text-white font-black text-[9px] shadow-xs">
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between text-[11px] text-slate-500 mt-2">
                  ...
                  <div className="flex items-center text-amber-600 font-bold group-hover:translate-x-0.5 transition-transform flex-shrink-0">
                    <span>쿠폰보기</span>
