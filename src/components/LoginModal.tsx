    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
      <div className="relative w-full max-w-sm bg-white border border-slate-200 rounded-3xl p-5 shadow-2xl text-slate-800 max-h-[90vh] overflow-y-auto no-scrollbar">
        ...
        <div className="mt-5 pt-3 border-t border-slate-200 space-y-1.5">
          ...
          <div className="p-2 rounded-xl bg-slate-50 border border-slate-200 text-[10px] text-slate-500">
            <span className="text-slate-700 font-bold">개인정보 보호 책임자:</span> 더휴랩 지정인 (<a href="mailto:jguy12@hanmail.net" className="text-cyan-600 underline">jguy12@hanmail.net</a>)
          </div>
        </div>
      </div>
    </div>
