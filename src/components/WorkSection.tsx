          ...
          return (
            <div
              ...
              className={`p-3.5 rounded-2xl transition-all cursor-pointer border ${
                isSelected
                  ? 'bg-slate-800/90 border-cyan-400 ring-2 ring-cyan-400/20 shadow-xl'
            ...
            >
              <div className="flex space-x-3">
                ...
                <div className="relative w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 bg-slate-800">
                  ...
                  />
                  <div className="absolute top-1 left-1 px-1.5 py-0.5 rounded bg-slate-950/80 backdrop-blur-xs text-[9px] font-bold text-cyan-300">
                    {ws.category}
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-1 flex-shrink-0 ml-1">
                      ...
                      <span className="text-xs font-semibold text-slate-200">{ws.rating}</span>
                      <span className="text-[10px] text-slate-500">({ws.reviewCount})</span>
                    </div>
                  </div>
